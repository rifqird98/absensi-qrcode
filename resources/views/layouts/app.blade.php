...
<html lang="en">
  ...
  <!-- Favicon -->
  <link rel="apple-touch-icon" sizes="120x120" href="{{ asset('/') }}assets/img/logosmk.png">
  <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('/') }}assets/img/logosmk.png">
  <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('/') }}assets/img/logosmk.png">
